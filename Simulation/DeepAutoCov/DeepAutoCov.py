...
def main(options):
    ...
    n = int(options.numb_weeks) # Number of Simulation Weeks (Example : if you have two hundred simulation weeks the n is equal a 199)
    ...
    for combo in all_combo[0:1]:
        ...
        for week in range(1,n): # Simulation weeks
            if week in retraining_week:
                ...
                with strategy.scope():
                    autoencoder,th = model(input_dim, encoding_dim, hidden_dim_1, hidden_dim_2, hidden_dim_3, hidden_dim_4, hidden_dim_5,reduction_factor, path_save_file) # Creation of the AutoEncoder model.
            ...
            if a == 9999: # if a week not contain the sequence, The pipeline stopped.
                break
