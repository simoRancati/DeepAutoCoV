...
def main(options):
    ...
    #dir_week =str('/Users/utente/Desktop/Varcovid/PAPAER_GROSSO/DATASET_PROVA/dataset_febb_2023_France/') # Path dataset generated by Data_Filtration_kmers.py.
    ...
    for combo in all_combo[0:1]:
        ...
        ## SIMULATION
        for week in range(1, 197): # Simulation weeks
...
if __name__ == "__main__":
    ...
    parser.add_option("-p", "--pathdrive", dest="path_drive",
                      ...
                      help="path to drive example: path/drive/", default="/blue/salemi/share/varcovid/DeepAutoCov/Datasets/Dataset_France/")   # default
    parser.add_option("-c", "--csv", dest="csv_path",

                      help="path to CSV file metadata", default="/blue/salemi/share/varcovid/DeepAutoCov/Datasets/filtered_metadatataset_France.csv")

    parser.add_option("-k","--kmers",dest="kmers",
                      help="path of file kmers",default='/blue/salemi/share/varcovid/DeepAutoCov/Datasets/Dataset_France/1/EPI_ISL_6331293.csv')

    parser.add_option("-s", "--pathsave ", dest="path_save",
                      help="path where we can save the file", default='/blue/salemi/share/varcovid/DeepAutoCov/Results/Results_France')
