...
def weeks_before(summary):
    ...
    week_identification_np=np.array([['B.1',4],['B.1.428',5],['B.1.39',5],['B.1.179',10],['B.1.298',16],['B.1.1',18],['B.1.1.261',20],['B.1.1.170',23],['B.1.1.288',24],['B.1.160',29],['B.1.177.21',29],['B.1.177.12',31],['B.1.1.7',49],['AY.122',75],['AY.4',73], ['AY.7.1',75], ['AY.43', 75], ['AY.4.6', 81], ['BA.2', 98],['BA.2.9', 98], ['BA.2.12.1', 120],['BA.2.3', 122], ['BA.5.1', 131], ['BA.5', 128], ['BA.5.2.1', 128], ['BF.7', 130], ['BN.1.3.1', 148], ['BQ.1.1', 148], ['CH.1.1',155], ['XAY.2.3', 154], ['XAY.2.2',152], ['XBB.1.5', 160], ['FK.1.2.1',161], ['DV.6',163], ['EG.5', 181], ['DV.7.1', 187], ['HW.1.1', 185]])
    week_growing_np=np.array([['B.1',2],['B.1.428',3],['B.1.39',3],['B.1.179',8],['B.1.298',1],['B.1.1',16],['B.1.1.261',2],['B.1.1.170',2],['B.1.1.288',3],['B.1.160',7],['B.1.177.21',3],['B.1.177.12',26],['B.1.1.7',9],['AY.122',8],['AY.4',6], ['AY.7.1',8], ['AY.43', 9], ['AY.4.6', 6], ['BA.2', 4],['BA.2.9', 4], ['BA.2.12.1', 9],['BA.2.3', 9], ['BA.5.1', 14], ['BA.5', 14], ['BA.5.2.1', 11], ['BF.7', 9], ['BN.1.3.1', 7], ['BQ.1.1', 11], ['CH.1.1',10], ['XAY.2.3', 1], ['XAY.2.2',3], ['XBB.1.5', 12], ['FK.1.2.1',6], ['DV.6',14], ['EG.5', 10], ['DV.7.1', 6], ['HW.1.1', 2]])
...
def lineages_of_interest():
    ## Valid Lineages
    valid_lineage_FDLs = ['B.1','B.1.428','B.1.39','B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288', 'B.1.160','B.1.177', 'B.1.177.21', 'B.1.177.12', 'B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6','AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3']  # mettere i lineage che definisco come classe# mettere i lineage che definisco come classe

    valid_lineage_newFDLS = ['BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6' , 'EG.5', 'DV.7.1', 'HW.1.1']
    valid_lineage = valid_lineage_FDLs + valid_lineage_newFDLS

    # Valid Lineages PRC
    valid_lineage_prc = [
        ['B.1','B.1.428','B.1.39','B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288', 'B.1.160','B.1.177', 'B.1.177.21', 'B.1.177.12', 'B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6','AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'], #0
        ['B.1.428','B.1.39','B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288', 'B.1.160','B.1.177', 'B.1.177.21', 'B.1.177.12', 'B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6','AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#4
        ['B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288', 'B.1.160','B.1.177', 'B.1.177.21', 'B.1.177.12', 'B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6','AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#5
        ['B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288', 'B.1.160','B.1.177', 'B.1.177.21', 'B.1.177.12', 'B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6','AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#10
        ['B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288', 'B.1.160','B.1.177', 'B.1.177.21', 'B.1.177.12', 'B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6','AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#16
        ['B.1.1.261', 'B.1.1.170', 'B.1.1.288', 'B.1.160','B.1.177', 'B.1.177.21', 'B.1.177.12', 'B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6','AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#18
        ['B.1.1.170', 'B.1.1.288', 'B.1.160','B.1.177', 'B.1.177.21', 'B.1.177.12', 'B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6','AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#20
        ['B.1.1.288', 'B.1.160','B.1.177', 'B.1.177.21', 'B.1.177.12', 'B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6','AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#23
        ['B.1.160','B.1.177', 'B.1.177.21', 'B.1.177.12', 'B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6','AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#24
        ['B.1.177.12', 'B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6','AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#29
        ['B.1.1.7', 'AY.122', 'AY.7.1', 'AY.43', 'AY.4.6', 'AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1', 'DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#31
        ['AY.122', 'AY.7.1', 'AY.43', 'AY.4.6', 'AY.4', 'BA.2', 'BA.2.9', 'BA.2.12.1', 'BA.2.3', 'BA.5','BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5', 'FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#49
        ['AY.122', 'AY.7.1', 'AY.43', 'AY.4.6', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6' , 'EG.5', 'DV.7.1', 'HW.1.1'],#73
        ['AY.4.6', 'BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5','FK.1.2.1','DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#75
        ['BA.2', 'BA.2.9', 'BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1','XAY.2.3', 'XAY.2.2', 'XBB.1.5', 'FK.1.2.1', 'DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#81
        ['BA.2.12.1','BA.2.3', 'BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1','XAY.2.3', 'XAY.2.2', 'XBB.1.5', 'FK.1.2.1', 'DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#98
        ['BA.5', 'BA.5.1', 'BA.5.2.1', 'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3','XAY.2.2', 'XBB.1.5', 'FK.1.2.1', 'DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'], #120
        ["BA.5.1",'BF.7', 'BN.1.3.1, BQ.1.1', 'CH.1.1','XAY.2.3', 'XAY.2.2', 'XBB.1.5', 'FK.1.2.1', 'DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#128
        ["BA.5.1", 'BN.1.3.1, BQ.1.1', 'CH.1.1','XAY.2.3', 'XAY.2.2', 'XBB.1.5', 'FK.1.2.1', 'DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#130
        ['BN.1.3.1, BQ.1.1', 'CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5', 'FK.1.2.1', 'DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#131
        ['CH.1.1', 'XAY.2.3', 'XAY.2.2', 'XBB.1.5', 'FK.1.2.1', 'DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#148
        ['XBB.1.5', 'FK.1.2.1', 'DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#155
        ['FK.1.2.1', 'DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#160
        ['DV.6', 'EG.5', 'DV.7.1', 'HW.1.1'],#161
        ['EG.5', 'DV.7.1', 'HW.1.1'],#163
        ['DV.7.1', 'HW.1.1'],#181
        ['DV.7.1'],#185
        []]#187
    ...
    dictionary_lineage_week = {
        4: ['unknown','B.1'],
        5: ['unknown', 'B.1', 'B.1.428', 'B.1.39'],
        10: ['unknown','B.1','B.1.428','B.1.39','B.1.179'],
        16: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179','B.1.298'],
        18: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179','B.1.298', 'B.1.1'],
        20: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1','B.1.1.261'],
        23: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261','B.1.1.170'],
        24: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288'],
        29: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21'],
        31: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12'],
        49: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7'],
        73: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4'],
        75: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1'],
        81: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6'],
        98: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9'],
        120: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3'],
        128: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1'],
        130: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7'],
        131: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1'],
        148: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1'],
        155: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2'],
        160: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5'],
        161: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5','FK.1.2.1'],
        163: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5','FK.1.2.1','DV.6'],
        181: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5','FK.1.2.1','DV.6','EG.5'],
        185: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5','FK.1.2.1','DV.6','EG.5','HW.1.1'],
        187: ['unknown', 'B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5','FK.1.2.1','DV.6','EG.5','HW.1.1','DV.7.1'],
        }
    ...
    lineage_know = [
                    ...
                    ['B.1'],
                    ['B.1','B.1.428','B.1.39'],
                    ['B.1','B.1.428','B.1.39','B.1.179'],
                    ['B.1','B.1.428','B.1.39','B.1.179','B.1.298'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179','B.1.298', 'B.1.1'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1','B.1.1.261'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261','B.1.1.170'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5','FK.1.2.1'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5','FK.1.2.1','DV.6'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5','FK.1.2.1','DV.6','EG.5'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5','FK.1.2.1','DV.6','EG.5','HW.1.1'],
                    ['B.1', 'B.1.428', 'B.1.39', 'B.1.179', 'B.1.298', 'B.1.1', 'B.1.1.261', 'B.1.1.170', 'B.1.1.288','B.1.160','B.1.177', 'B.1.177.21','B.1.177.12','B.1.1.7','AY.4','AY.122', 'AY.43', 'AY.7.1','AY.4.6','BA.2','BA.2.9','BA.2.12.1','BA.2.3','BA.5','BA.5.2.1','BF.7','BA.5.1','BQ.1.1','BN.1.3.1','CH.1.1','XAY.2.3','XAY.2.2','XBB.1.5','FK.1.2.1','DV.6','EG.5','HW.1.1','DV.7.1']

                      ]
    return valid_lineage,valid_lineage_prc,dictionary_lineage_week,lineage_know

def retraining_weeks():
    retraining_week = [4, 5, 10, 16, 18, 20, 23, 24, 29, 31, 49, 73, 75, 81, 98, 120, 128, 130, 131, 148, 155, 160, 161, 163, 181, 185, 187]
    retraining_week_false_positive = [4, 5, 10, 16, 18, 20, 23, 24, 29, 31, 49, 73, 75, 81, 98, 120, 128, 130, 131, 148, 155, 160, 161, 163, 181, 185, 187, 190]
...
def write_precision(precision,week,n = 50):
